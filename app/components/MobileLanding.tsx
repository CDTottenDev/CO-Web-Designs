...
export default function MobileLanding() {
  ...
  return (
    <div className="h-screen w-full flex bg-emerald-100 dark:bg-emerald-900 overflow-hidden">
      {/* Left Column */}
        ...
        <div className="flip-container h-full m-0 p-0 border-0">
          <div className="flipper h-full m-0 p-0 border-0">
            ...
            <div className="back flex flex-col h-full">
              ...
              <Link href="/knowledge-hub" className="flex-[0_0_33.35vh] bg-[#a6bcb4] dark:bg-[#73867e] 
