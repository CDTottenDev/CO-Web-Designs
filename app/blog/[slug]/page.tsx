  ...
  return (
    <div className="bg-gradient-to-b from-white to-gray-100 min-h-screen">
      <div className="container mx-auto px-4 py-8">
        ...
        <article className="container mx-auto px-4 py-8 max-w-4xl bg-white border-2 border-black retro-shadow">
          <div className="mb-12 text-center">
            <div className="inline-block bg-yellow-300 px-3 py-1 mb-4 border-2 border-black retro-shadow">
