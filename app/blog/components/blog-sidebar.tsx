      ...
      <div className="sticky top-0 p-4 space-y-6">
        <form onSubmit={handleSearch} className="relative">
          <Input
            ...
            className="pl-9 bg-white/50 backdrop-blur-sm border-red-200 focus-visible:ring-red-200 dark:bg-gray-800/50 dark:border-red-800 dark:focus-visible:ring-red-800 dark:text-white"
            value={searchQuery}
        ...
        <Accordion type="single" collapsible defaultValue="categories">
          <AccordionItem value="categories">
            <AccordionTrigger className="text-red-900 hover:text-red-700 dark:text-red-200 dark:hover:text-red-400">
              Categories
            </AccordionTrigger>
            <AccordionContent>
