  ...
  return (
    <section className="py-16 bg-gradient-to-b from-blue-50 to-white">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-center mb-8 text-blue-800">Why Choose Central Oregon Web Designs?</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h3 className="text-2xl font-semibold mb-4 text-blue-700">Hands-On Experience</h3>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h3 className="text-2xl font-semibold mb-4 text-blue-700">Technical Expertise</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h3 className="text-2xl font-semibold mb-4 text-blue-700">Custom-Tailored Websites</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h3 className="text-2xl font-semibold mb-4 text-blue-700">Personal Touch</h3>
            <p className="text-gray-600">
        ...
        <div className="bg-blue-100 p-8 rounded-lg shadow-xl mb-12">
          <h3 className="text-3xl font-bold mb-6 text-blue-800">Custom Websites vs. Cookie-Cutter Solutions</h3>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h4 className="text-xl font-semibold mb-3 text-blue-700">Custom Websites</h4>
            ...
            <div>
              <h4 className="text-xl font-semibold mb-3 text-blue-700">Cookie-Cutter Websites</h4>
              <ul className="list-disc pl-5 text-gray-700">
